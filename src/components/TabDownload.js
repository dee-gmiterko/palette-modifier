                ...
                <div className="row">
                    <div className="small-12 medium-6 columns">
                        <div>
                            ...
                            <p className="text-center">
                                <a className="button dowload success large" onClick={this.download.bind(this)} style={{marginTop: '1.3em'}}>Save</a> <br/>
                            </p>
                            <p>This will apply new palette to full-size image and let you save it. If you aren't satisfied with result you can</p>
                            <a className="button small" onClick={() => $('#app-tabs').foundation('selectTab', 'select')}>Try another image</a>
                            <a className="button small" onClick={() => $('#app-tabs').foundation('selectTab', 'modify')}>Modify palette</a>
                        </div>
                        <div>
                    ...
                    <div className="small-12 medium-6 columns">
                        <div className="row">
                            <div className="small-6 columns">
                                <img src={this.props.originalImage} alt="Original" />
                            </div>
                            <div className="small-6 columns">
                    ...
                    <div className="small-12 columns">
                        <footer className="clearfix padding-top text-center">
                            <a className="float-left button small" onClick={() => $('#app-tabs').foundation('selectTab', 'modify')}>Modify palette</a>
